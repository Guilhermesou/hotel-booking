...
export default function ShiftsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!validateTime()) {
      addToast({
        title: "Erro",
        description: "Horário de início deve ser antes do término.",
        color: "danger",
      });
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <Select
              ...
              onChange={(e) =>
                setForm({
                  ...form,
                  staffId: (e.target as HTMLSelectElement).value,
                })
              }
            >
      ...
      <Card className="p-0 overflow-hidden">
        <div
          className={`grid grid-cols-4 gap-4 p-3 text-sm font-medium ${
            theme === "dark"
