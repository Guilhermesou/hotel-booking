...
export default function EditReservationModal({ reservation, guests, rooms, onUpdated }: Props) {
  ...
  return (
    <>
      <div onClick={onOpen} className="cursor-pointer bg-blue-500 text-white rounded px-1 text-sm truncate">
        Edit
      </div>
